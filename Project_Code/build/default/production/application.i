...
void convert_byte_string(uint_8 value, uint_8 *str);
void convert_short_string(uint_16 value, uint_8 *str);
void convert_int_string(uint_32 value, uint_8 *str);
...
ret = lcd_4_bit_send_command(&lcd_1, 7);
ret = lcd_8_bit_send_string_position(&lcd_2, 1,1,"Aya");
ret = lcd_8_bit_send_string(&lcd_2, "aya");
ret = lcd_8_bit_send_data_position(&lcd_2, 4 ,8,9);
ret = lcd_8_bit_send_char_data(&lcd_2, 'u');
while(1){
